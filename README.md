...
**Kubernetes DB note**  
Kubernetes no longer deploys the bundled MySQL pod/service; the cluster relies on the managed DigitalOcean MySQL instance (with automated backups). Local development still uses Docker Compose for MySQL.
